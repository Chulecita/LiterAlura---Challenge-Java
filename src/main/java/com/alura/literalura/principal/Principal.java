            ...
            System.out.println("*****************");
                ...
                if (libroExiste.isPresent()){
                    ...
                    if (!primerLibro.autor().isEmpty()) {
                        ...
                        Optional<Autor> autorOptional = repositoryAutor.findByNombre(autorLibro.getNombre());
                        ...
                        if (autorOptional.isPresent()) {
                            ...
                            Autor autorNuevo = repositoryAutor.save(autorLibro);
                        ...
                        System.out.printf("Titulo: %s%nAutor: %s%nIdioma: %s%nNumero de Descargas: %s%n",
                                libro.getTitulo(), autorLibro.getNombre(), libro.getLenguaje(), libro.getNumero_descargas());
                        System.out.println("***************************\n");
                    } else {
